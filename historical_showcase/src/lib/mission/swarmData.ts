...
const CANDIDATE_VESSELS: SwarmVessel[] = [
  ...
  },
  {
    ...
    flag: "Unknown",
    vesselType: "tanker",
    typeLabel: "Unknown (SAR-only detection)",
    ...
    suspicionLevel: "high",
    isDarkVessel: true,
    suspiciousReason: "12.0h AIS transponder blackout correlated with Sentinel-1A SAR radar target at plume origin",
  ...
  },
  {
    ...
    suspicionLevel: "high",
    isDarkVessel: true,
    suspiciousReason: "Nighttime 90° heading shift and deliberate 6.2h AIS blackout traversing TSS outer separation zone",
