...
function getKeralaStageLabel(stage: MissionStage): string {
  const keralaLabels: Record<MissionStage, string> = {
    STANDBY: "STANDBY",
    SAR_ACQUISITION: "01 · SCANNING & DETECTION",
    VALIDATION_AUDIT: "02 · SLICK SEGMENTATION & LOOK-ALIKE FILTER",
    AIS_SWARM: "03 · BI-DIRECTIONAL DRIFT MODELING",
    BACKTRACK_CORRIDOR: "04 · AIS MATCHING & VESSEL STATUS",
    CULPRIT_LOCK: "05 · CORRIDOR VALIDATION",
    CONTAINMENT_ROOM: "06 · FORWARD DRIFT FORECAST",
    CASE_FILE: "07 · VALIDATION DASHBOARD"
  };
  return keralaLabels[stage] ?? STAGE_LABELS[stage] ?? stage;
}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
          ...
          >
            {state.scenario === "kerala" 
              ? getKeralaStageLabel(state.currentStage as MissionStage) 
