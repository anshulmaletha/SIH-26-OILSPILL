...
const CANDIDATE_VESSELS: SwarmVessel[] = [
  ...
  },
  {
    ...
    eta: "UNKNOWN",
    lastSeen: "SAR Sensor Detection (No AIS)",
    lengthMeters: 175,
    beamMeters: 28,
    draughtMeters: 9.8,
    isCandidate: true,
    suspicionLevel: "high",
    isDarkVessel: true,
    suspiciousReason: "12.0h continuous AIS blackout throughout observation window. Correlated with Sentinel-1A SAR radar target at plume origin.",
    threatTag: "HIGH ANOMALY (AIS BLACKOUT)",
    trajectory: [
      [71.55, 19.55],
      [71.72, 19.42],
      [71.84, 19.33],
  ...
  },
  {
    ...
    lastSeen: "04:18:22 UTC (Intermittent)",
    lengthMeters: 160,
    beamMeters: 26,
    draughtMeters: 8.5,
    isCandidate: true,
    suspicionLevel: "high",
    isDarkVessel: true,
    suspiciousReason: "Unreported speed deceleration & 4.8h transponder shutdown near northern corridor feeder lane.",
    threatTag: "SUSPICIOUS (ROUTE DEVIATION)",
    trajectory: [
      [71.30, 20.35],
      [71.38, 20.15],
      [71.42, 20.02],
  ...
  },
  {
    ...
    lastSeen: "03:45:10 UTC (Signal Dropped)",
    lengthMeters: 225,
    beamMeters: 36,
    draughtMeters: 12.0,
    isCandidate: true,
    suspicionLevel: "high",
    isDarkVessel: true,
    suspiciousReason: "Nighttime 90° heading shift and deliberate 6.5h AIS blackout traversing outer TSS zone.",
    threatTag: "SUSPICIOUS (AIS GAP)",
    trajectory: [
      [72.70, 18.45],
      [72.52, 18.52],
      [72.38, 18.59],
  ...
  },
  {
    ...
    eta: "UNKNOWN",
    lastSeen: "03:30:00 UTC (Blackout)",
    lengthMeters: 180,
    beamMeters: 30,
    draughtMeters: 9.2,
    isCandidate: true,
    suspicionLevel: "high",
    isDarkVessel: true,
    suspiciousReason: "8.5h transponder blackout coinciding with backtracked drift corridor origin.",
    threatTag: "HIGH ANOMALY (CORRIDOR ORIGIN)",
    trajectory: [
      [70.70, 19.85],
      [70.82, 19.72],
      [70.90, 19.62],
